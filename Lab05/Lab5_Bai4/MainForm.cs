...
namespace Lab4_Bai7
{
    public partial class MainForm : Form
    {
        ...
        private void button_angigio_Click(object sender, EventArgs e)
        {
            ...
            ShowMonAn showMonAn = new(tokenType, accessToken, url, smtpClient, isconnected, emaillab5);
            showMonAn.Show();
        }
        ...
        {
            emailsetting = new emailSetting(username);
            emailsetting.SaveClicked += EmailSetting_SaveClicked;
            emailsetting.Show();
        }
        private void EmailSetting_SaveClicked(object sender, EventArgs e)
        {
            if (emailsetting != null && emailsetting.SmtpClientInstance != null)
            {
                smtpClient = emailsetting.SmtpClientInstance;
                isconnected = emailsetting.isconnected;
                emaillab5 = emailsetting.email;
                MessageBox.Show("Email setting saved successfully!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}